...
public class MqttServerClientCertRequiredSslTest extends MqttServerBaseTest {

  private static final Logger log = LoggerFactory.getLogger(MqttServerClientCertRequiredSslTest.class);
  ...
  public void untrustedClient(TestContext context) {
    ...
    try {
      ...
      context.fail("We should get exception!");

    } catch (MqttException e) {
      if (e.getCause() instanceof SSLHandshakeException) {
        // Note: It is impossible to diagnose exception type in portable way

        context.assertFalse(this.clientConnectedWithSsl);
  ...
  @Test
  public void clientWithoutCert(TestContext context) {
